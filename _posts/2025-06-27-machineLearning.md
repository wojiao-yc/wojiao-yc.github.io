...
1. 当先验分布是**均匀分布**时，MAP退化为MLE
2. MAP可以看作是MLE加上对参数的先验知识
3. 随着数据量增加，先验的影响减小，MAP会趋近于MLE
...
## 最小二乘法
最小二乘法是一种数学优化技术，常用于数据拟合问题，目标是找到一个函数，使其尽可能准确地逼近一组观测数据，推荐阅读这篇[知乎专栏](https://zhuanlan.zhihu.com/p/38128785)
